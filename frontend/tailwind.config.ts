  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "selected-pulse":
          "motion-selected-pulse 0.6s var(--ease-out-soft)",
        "page-enter":
          "motion-page-enter var(--motion-slow) var(--ease-out-soft) both",
      ...
      keyframes: {
        ...
        "motion-selected-pulse": {
          "0%": { boxShadow: "0 0 0 0 rgba(42, 157, 143, 0.3)" },
          "70%": { boxShadow: "0 0 0 6px rgba(42, 157, 143, 0)" },
          "100%": { boxShadow: "0 0 0 0 rgba(42, 157, 143, 0)" },
        },
        "motion-page-enter": {
