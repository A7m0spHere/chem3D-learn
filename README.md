...
<p align="center">
  <a href="https://a7m0sphere.github.io/chem3D-learn/">在线体验</a> ·
  <a href="#真实界面">真实界面</a> ·
  <a href="#核心能力">核心能力</a> ·
  <a href="#快速开始">快速开始</a> ·
  <a href="#项目结构">项目结构</a> ·
...
> 正式站点由 GitHub Pages 托管，并为 `createBrowserRouter` 配置了 SPA history fallback；直接访问 `/modules`、`/module/...` 等深层链接也会进入 React 应用。
