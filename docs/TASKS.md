...
- **当前状态**：**已完成**（2026-08-07）。T-038A 审计、T-038B NH₃ 四步数据契约、T-038C UI 消费与 T-038D 行为 / 响应式 / production / 视觉边界验收均已完成；普通分子 Viewer 的 NH₃ 是首个代表模块。详见 `docs/guided-observation/T038_VIEWER_AUDIT.md`。
- **任务拆解建议**：
