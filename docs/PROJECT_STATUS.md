...
> 最后更新：2026-08-03（Codex，撤销 T-035 并纠正产品方向）
...
下一项是 **T-038：3D 引导观察与结构解释样板**。先选择一个已有核心 Viewer，审计其观察目标、3D 操作、状态变化和解释链，只做一个轻量样板；完成后再恢复 T-031 小范围 Alpha。不要重新引入选择题、判题、分数、重试或题库路线，也不要在没有样板证据时批量扩展所有模块。
