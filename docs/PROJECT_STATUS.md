...
> 最后更新：2026-08-27（进度文档整理。历史任务结果与 2026-07-25～08-13 逐日独立验证日志已移至 `docs/archive/PROJECT_STATUS_ARCHIVE_20260827.md`，本文件只保留当前事实）
> 上一次实质进展更新：2026-08-13（T-039A～D 全站 3D-first 收缩完成）
...
- **任务面**：无进行中或已领取任务；`main`（HEAD `14badfe`）自 2026-08-13 后无新提交。
- **两个开放决策**：
  1. 过期 Darwin 快照的解法——原计划的 macOS 集中审核，或迁移到可复现 CI 环境（见 `docs/TASKS.md` 待办区）；
  2. 是否重启 T-031 真实用户反馈收集（其暂停时设定的恢复条件已满足）。
